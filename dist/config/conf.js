...
exports.STORE_PROCEDURE = exports.ZKTECO_CONFIG = exports.config = void 0;
...
exports.ZKTECO_CONFIG = {
    ZKTECO_BASE_URL: (_a = process.env.ZKTECO_BASE_URL) !== null && _a !== void 0 ? _a : "",
    ZKTECO_USERNAME: (_b = process.env.ZKTECO_USERNAME) !== null && _b !== void 0 ? _b : "admin",
    ZKTECO_PASSWORD: (_c = process.env.ZKTECO_PASSWORD) !== null && _c !== void 0 ? _c : "admin123",
    // Auth
    ZKTECO_BASE_URL_JWT_API_TOKEN_AUTH: "/jwt-api-token-auth/",
    // Personnel
    // Device
};
exports.STORE_PROCEDURE = {
    ADMS: {
